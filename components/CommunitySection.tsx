...
export default function CommunitySection() {
  const { bgSection, fg } = useTheme()
  return (
    <section className="container" style={{ paddingTop: 150, paddingBottom: 150, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 100, alignItems: 'center', background: bgSection }} id="community">
      <Parallax speed={0.25}>
      ...
      <Parallax speed={0.15}>
        <div>
          <h2 style={{ fontFamily: 'var(--font-unbounded)', fontSize: 60, lineHeight: 1, marginBottom: 30, color: fg }}>
            Join the<br /><span style={{ color: '#F97316' }}>Flow Crew.</span>
          </h2>
          <p style={{ fontSize: 20, opacity: 0.7, marginBottom: 30, color: fg, fontWeight: 300 }}>
