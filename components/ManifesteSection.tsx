  ...
  return (
    <section style={{ background: 'transparent', position: 'relative', overflow: 'hidden' }}>
      <div className="container" style={{ paddingTop: isMobile ? 60 : 120, paddingBottom: isMobile ? 60 : 120, textAlign: 'center' }}>
        <div style={{ fontFamily: 'var(--font-unbounded)', fontSize: 'clamp(26px,5vw,72px)', fontWeight: 900, letterSpacing: -2, lineHeight: 1.05, position: 'relative', maxWidth: 900, margin: '0 auto 40px', color: '#F2EDE5' }}>
        ...
        <p style={{ fontSize: isMobile ? 14 : 16, color: 'rgba(242,237,229,0.45)', fontWeight: 300, maxWidth: 480, margin: '0 auto', lineHeight: 1.8 }}>
